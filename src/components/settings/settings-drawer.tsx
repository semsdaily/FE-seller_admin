...
function LithiumLayoutIcon({ ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <rect
        ...
        rx={1.175}
      />
      <path stroke="currentColor" strokeWidth={0.65} d="M.5 3.75h11" />
    </svg>
  );
}
  ...
  return (
    <DrawerBlock title="Layout">
      ...
      >
        ...
        <RadioBox value={LAYOUT_OPTIONS.LITHIUM} className="h-20  py-4">
          <LithiumLayoutIcon
            aria-label="Lithium Layout"
            className="me-1.5 h-auto w-6"
          />
          Lithium
        </RadioBox>
      ...
      >
        <Button
          ...
          className={cn(
            ...
            theme === 'dark' && colorPresetName === 'black' && 'dark:bg-gray-50'
          )}
        >
